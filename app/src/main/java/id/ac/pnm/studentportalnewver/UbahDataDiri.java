...
public class UbahDataDiri extends AppCompatActivity {
    String npm;
    String url1 = "https://dekadragonslayer.000webhostapp.com/dtdiri/readdiribynpm.php";
    String url2 = "https://dekadragonslayer.000webhostapp.com/dtdiri/editdiri.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        npm = extras.getString("NPM_ubahdtdiri");
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(UbahDataDiri.this);
        ...
        btnsubmitEDtDr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < a.length(); i++) {
                                ...
                                Toast.makeText(UbahDataDiri.this, berhasil, Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(UbahDataDiri.this, UbahDataDiri.class);
                                intent.putExtra("NPM_ubahdtdiri", npmEDtDr2);
                ...
                RequestQueue requestQ = Volley.newRequestQueue(UbahDataDiri.this);
